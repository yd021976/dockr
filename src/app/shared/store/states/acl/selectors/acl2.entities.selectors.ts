...
export class AclEntitiesSelectors {
    ...
    static treenode_get_rootRoleEntity( node: AclTreeNode ): ( ...args: any[] ) => RoleEntity {
        return createSelector( [ AclEntitiesState ], ( state: AclStateEntitiesModel ): RoleEntity => {
    ...
    static role_get_denormalizeEntity( role_entity: RoleEntity ) {
        return createSelector( [ AclEntitiesState ], ( state: AclStateEntitiesModel ): RoleModel => {
            const role_model: RoleModel = AclEntitiesState.normalizr_utils.denormalize( role_entity.uid, AclEntitiesState.normalizr_utils.roleSchema, {
    ...
    static entity_get_fromUid( uid: string, node_type: NODE_TYPES ): ( ...args: any ) => RoleEntity | BackendServiceEntity | CrudOperationModelEntity | DataModelPropertyEntity {
        return createSelector( [ AclEntitiesState ], ( state: AclStateEntitiesModel ): RoleEntity | BackendServiceEntity | CrudOperationModelEntity | DataModelPropertyEntity => {
